...
**3. Graph.** Promote high-confidence pairs into a [knowledge graph](/glossary/knowledge-graph) edge, then use community detection to find over-merges (one "entity" that is actually five) and missing merges (two communities sharing a directing mind).
...
Under [KYC](/glossary/kyc) obligations, "we merged because the names looked similar" is not a defensible answer. "We merged because ICO matched exactly and beneficial ownership overlapped 100%, here is the audit trail" is. Entity resolution without an audit trail is a liability.
...
- **Glossary**: [Entity Resolution](/glossary/entity-resolution), [Entity Graph](/glossary/entity-graph), [Due Diligence](/glossary/due-diligence), [KYC](/glossary/kyc), [Knowledge Graph](/glossary/knowledge-graph)
