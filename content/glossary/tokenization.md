...
- [Ollama](@/glossary/ollama.md) -- Local AI runtime applying tokenization to model inputs
- [Meilisearch](@/glossary/meilisearch.md) -- Search engine using tokenization for full-text indexing
- [Vector Database](@/glossary/vector-database.md) -- Storage consuming tokenized embeddings for similarity search
- [Data Pipeline](@/glossary/data-pipeline.md) -- Processing infrastructure where tokenization is a preprocessing stage
- [Stream Processing](@/glossary/stream-processing.md) -- Real-time processing where incremental tokenization enables streaming
- [ETL](@/glossary/etl.md) -- Extract-transform-load pipelines including tokenization transforms
