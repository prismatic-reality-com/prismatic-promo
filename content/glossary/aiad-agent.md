...
- [Agent Profile](/glossary/agent-profile/) -- the declarative identity document for each agent
- **Command Registry** -- maps user commands to agents
- [Auto-Discovery](/glossary/auto-discovery/) -- automatic agent detection and registration
- **Collaboration** -- multi-agent coordination patterns
- [Access Control](/glossary/access-control/) -- authority enforcement on agent operations

## See Also

- [AIAD Standard](/glossary/aiad/) -- the framework specification
- [Agent Registry](.claude/AGENT_REGISTRY.md) -- complete listing of all agents
- [Color Teams](/glossary/color-teams/) -- security-focused agent teams
