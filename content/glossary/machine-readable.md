...
- [API](/glossary/api/) -- the primary interface through which machine-readable data is exchanged between systems
- [JSON Schema](/glossary/json-schema/) -- the schema language for validating machine-readable JSON data
- [OpenAPI](/glossary/openapi/) -- the machine-readable specification standard for REST API contracts
- [REST API](/glossary/rest-api/) -- the architectural style for machine-readable web service interfaces
- [Data Pipeline](/glossary/data-pipeline/) -- the infrastructure for processing and transforming machine-readable data flows
- [ETL](/glossary/etl/) -- Extract, Transform, Load operations on machine-readable data sources
- [Structured Logging](/glossary/structured-logging/) -- machine-readable log entries enabling automated analysis
- [Schema](/glossary/schema/) -- the structural definition that gives semantic meaning to machine-readable data
- [Metadata Management](/glossary/metadata-management/) -- organizing and maintaining machine-readable descriptive information
- [Typespec](/glossary/typespec/) -- Elixir's machine-readable type annotation system

## See Also

- [Prismatic API](/glossary/prismatic-api/) -- the auto-introspecting REST gateway built on machine-readable type annotations
- [OpenAPI Spec](/glossary/openapi-spec/) -- the machine-readable API specification generated by the Prismatic API
- [Swagger UI](/glossary/swagger-ui/) -- the interactive documentation generated from machine-readable OpenAPI specs
- [AIAD](/glossary/aiad/) -- the agent standard using machine-readable YAML specifications
- [Quality DNA](/glossary/quality-dna/) -- machine-readable JSON persistence for quality metrics
- [Dialyzer](/glossary/dialyzer/) -- static analysis consuming machine-readable typespecs
