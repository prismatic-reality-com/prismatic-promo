...
- [Module](/glossary/module/) -- Elixir modules that contain and are generated by macros
- [AST](/glossary/ast/) -- Abstract Syntax Tree representation that macros manipulate
- [Behaviour](/glossary/behaviour/) -- Elixir's interface mechanism, often combined with macros
- [Compilation](/glossary/compilation/) -- the phase during which macros execute and expand
- [Process](/glossary/process/) -- processes that host the ETS registries populated by metaprogramming
- [ETS](/glossary/ets/) -- Erlang Term Storage used as the runtime target of compile-time registration
- [Registry](/glossary/registry/) -- the runtime data structure populated by self-registering macros
- [DSL](/glossary/dsl/) -- domain-specific languages built using macro-based code generation
- [Protocol](/glossary/protocol/) -- Elixir's polymorphism mechanism, an alternative to macros
...
- [Code Generation](/glossary/code-generation/) -- broader category of techniques including macros

## See Also

- [Architecture](/architecture/) -- self-registering architecture patterns across the platform
- [Capabilities](/capabilities/) -- extensibility through metaprogramming-based plugin systems
- [OSINT Toolbox](/osint/) -- 157 self-registering tools powered by metaprogramming
- [Academy](/academy/) -- topic auto-discovery via the same metaprogramming pattern
