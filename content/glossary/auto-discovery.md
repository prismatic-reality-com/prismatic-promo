...
- [AIAD Agent](@/glossary/aiad-agent.md) -- agents discovered via profile scanning
- [Agent Profile](@/glossary/agent-profile.md) -- declarative documents enabling agent discovery
...
- [OSINT Toolbox](@/osint/_index.md) -- 127 self-discovered OSINT tools
