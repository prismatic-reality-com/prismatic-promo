...
- [Mix Task](/glossary/mix-task/) -- Build tool providing the `mix git_trees` command interface
- [AIAD](/glossary/aiad/) -- Agent standard mandating Git Trees usage for all codebase exploration
- [Session Discipline](/glossary/session-discipline/) -- Workflow protocol requiring efficient exploration tools
- [Quality Gates](/glossary/quality-gates/) -- Pipeline consuming Git Trees data for file analysis
- [Agent Registry](/glossary/agent-registry/) -- Registry of 434 agents all required to use Git Trees
- [GitLab CI/CD](/glossary/gitlab-ci/) -- CI pipeline leveraging Git Trees for fast file enumeration
- [Continuous Integration](/glossary/continuous-integration/) -- CI workflow using Git Trees for quality checks

## See Also

- [Architecture](/architecture/) -- Platform architecture overview
- [Technologies](/technologies/) -- Technology stack details
- [Commands](/commands/) -- Platform commands including git_trees
