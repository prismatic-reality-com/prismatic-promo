...
- [Backward Compatibility](@/glossary/backward-compatibility.md) -- maintaining existing behavior across versions
...
- [Prismatic API](@/glossary/prismatic-api.md) -- the platform's REST gateway
