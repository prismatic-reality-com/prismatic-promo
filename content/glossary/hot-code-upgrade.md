...
- [BEAM](/glossary/beam/) -- Virtual machine providing hot code upgrade capability
- [OTP](/glossary/otp/) -- Framework with code_change callbacks
- [GenServer](/glossary/genserver/) -- Server behavior with state migration support
- [Environment](/glossary/environment/) -- Deployment environment configuration
- [Health Check](/glossary/health-check/) -- Verification after code upgrade
