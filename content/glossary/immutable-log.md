...
- [Event Log](/glossary/event-log/) -- Event-focused append-only storage
- [Event](/glossary/event/) -- Individual log entries
- [Incident Reporting](/glossary/incident-reporting/) -- NIS2 reporting from log data
- [HMAC Signature](/glossary/hmac-signature/) -- Cryptographic integrity for log entries
