...
A particularly insidious variant is "snapshot cherry picking": selecting a specific point in time at which the available evidence most strongly supports the desired conclusion, rather than using the current state. This is detectable through the [audit trail](/glossary/audit-trail/), which records the evidence state at every analysis timestamp and can identify whether the selected snapshot is suspiciously favorable.
...
1. **Signal type invariance**: The signal type (supporting vs. contradicting) is assigned at ingestion based on objective criteria and cannot be changed by downstream processing. Reframing the narrative does not change the signal's structural role in the [belief graph](/glossary/belief-graph/).

2. **[Red Team](/glossary/red-team/) adversarial review**: The Red Team's `red-epistemic-attacker` agent specifically tests for framing manipulation by generating alternative framings of key evidence and evaluating whether the conclusion changes under different framings.
...
The platform implements multiple structural detectors for cherry picking, operating on the [belief graph](/glossary/belief-graph/) topology:
...
4. The [audit trail](/glossary/audit-trail/) records the detection event with full provenance
...
The [Monte Carlo verification](/glossary/monte-carlo-verification/) stage naturally tests for cherry picking through its perturbation scenarios. If signal removal scenarios consistently collapse the conclusion, the conclusion depends on specific signals rather than broad evidential support -- the hallmark of cherry picking.

## Relationship to NABLA Axioms

Cherry picking violates or circumvents multiple [NABLA Infinity](/glossary/nabla-infinity/) axioms simultaneously:

| Axiom | How Cherry Picking Violates It |
|-------|-------------------------------|
| [Signal Plurality](/glossary/signal-plurality/) | Selectively excluding signals reduces effective plurality below the minimum |
| [Contradiction Preservation](/glossary/contradiction-preservation/) | Suppressing contradictory signals eliminates contradictions rather than preserving them |
| Absence Informative | Cherry picking treats absent contradictions as confirmation rather than as missing data |
| [Time Decay](/glossary/time-decay/) | Temporal cherry picking applies decay asymmetrically |
| Source Independence | Aggregation cherry picking conflates independent sources to reduce apparent contradictions |
| [Provenance Mandatory](/glossary/provenance-mandatory/) | Cherry picking obscures the provenance of the selection decision itself |
...
- [NABLA Infinity](/glossary/nabla-infinity/) -- Epistemic framework classifying cherry picking as a forbidden anti-pattern
- [Contradiction Preservation](/glossary/contradiction-preservation/) -- Axiom directly preventing the suppression that cherry picking requires
- [Signal Plurality](/glossary/signal-plurality/) -- Axiom ensuring sufficient evidence breadth to detect cherry picking
- [Belief Graph](/glossary/belief-graph/) -- Data structure on which cherry picking detection operates
- [Confidence Scoring](/glossary/confidence-scoring/) -- Multiplicative formula that penalizes cherry-picked conclusions through low robustness
- [Epistemic Robustness](/glossary/epistemic-robustness/) -- Robustness score as indirect cherry picking detector
- [QEVE](/glossary/qeve/) -- Verification engine whose perturbation testing reveals cherry picking
- [Trinity Gate](/glossary/trinity-gate/) -- Verification gate blocking cherry-picked conclusions from acceptance
- [Provenance Mandatory](/glossary/provenance-mandatory/) -- Axiom enabling audit of evidence selection decisions
- [Audit Trail](/glossary/audit-trail/) -- Immutable record enabling retrospective cherry picking detection
- [Red Team](/glossary/red-team/) -- Adversarial team testing platform resistance to cherry picking attacks
- [Blue Team](/glossary/blue-team/) -- Defensive team implementing symmetric aggregation against cherry picking
- [Time Decay](/glossary/time-decay/) -- Temporal mechanism susceptible to asymmetric application (temporal cherry picking)
- [Monte Carlo Verification](/glossary/monte-carlo-verification/) -- Perturbation testing revealing cherry picking through robustness signatures
