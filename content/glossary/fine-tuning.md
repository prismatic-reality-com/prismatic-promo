...
- [Ollama](/glossary/ollama/) - Local AI runtime hosting fine-tuned model variants via Modelfile adapters
- [Inference](/glossary/inference/) - Running fine-tuned models to generate predictions and outputs
- [Vector Database](/glossary/vector-database/) - Storage for embeddings generated by fine-tuned models
- [Data Pipeline](/glossary/data-pipeline/) - Processing infrastructure preparing fine-tuning datasets
- [Quality Gates](/glossary/quality-gates/) - Validation systems filtering training data by quality score
- [Telemetry](/glossary/telemetry/) - Metrics tracking fine-tuned model performance against baselines
- [Knowledge Graph](/glossary/knowledge-graph/) - Structured knowledge complementing fine-tuned model capabilities
...
- [Agents](/agents/) -- AIAD agents using fine-tuned models
