...
- [Prismatic Core](/apps/prismatic-core/) -- Foundation module with Monte Carlo engine and bifurcation analysis
- [Prismatic Monte Carlo](/apps/prismatic-monte-carlo/) -- Probabilistic simulation engine
- [AI Drift](/apps/ai-drift/) -- AI Drift detection system using this library
- [Trinity Gate](/capabilities/trinity-gate/) -- Formal verification of algorithm invariants
- [Multi-Paradigm Solving](/capabilities/multi-paradigm-solving/) -- Combining statistical, algebraic, and optimization approaches
