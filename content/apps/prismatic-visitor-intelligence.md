...
HAWKEYE combines signals from browser fingerprinting, geolocation, behavioral analysis, and external [threat intelligence](/glossary/threat-intelligence/) feeds ([AbuseIPDB](/osint/abuseipdb/), [GreyNoise](/osint/greynoise/), [Shodan](/osint/shodan/)) to build a comprehensive visitor profile and assign a dynamic [risk score](/glossary/risk-score/). The system processes each visitor request in under 100 milliseconds, enabling real-time threat assessment without perceptible impact on page load times.
...
Enrichment results are cached in [ETS](/apps/prismatic-storage-ets/) with configurable TTL (default: 1 hour for IP reputation, 24 hours for infrastructure data) to minimize external API calls. Cache keys include the IP address and the source identifier, enabling selective invalidation when a specific source's data changes.
...
The HAWKEYE dashboard is accessible at `/visitors` within the [Prismatic Web](/apps/prismatic-web/) interface, providing real-time visibility into visitor activity.
...
|-------------|-------------|
| [Prismatic Web](/apps/prismatic-web/) | Dashboard hosting and [LiveView](/glossary/liveview/) |
| [Prismatic Perimeter](/apps/prismatic-perimeter/) | Threat intelligence sharing |
| [Prismatic Cache](/apps/prismatic-cache/) | Intelligence query caching |
| [Prismatic Telemetry](/apps/prismatic-telemetry/) | Visitor [metrics](/glossary/metrics/) |
...
- [AbuseIPDB](/osint/abuseipdb/) - IP reputation scoring
- [GreyNoise](/osint/greynoise/) - Mass scanner identification
- [Shodan](/osint/shodan/) - Infrastructure fingerprinting

## Related Agents

- [Alert Management Specialist](/agents/alert-management-specialist/) -- Manages visitor threat alerts with severity-based routing
- [GitLab Security Specialist](/agents/gitlab-security-specialist-agent/) -- Security posture assessment for visitor threat detection validation
- [DX Brutalist Analyst](/agents/dx-brutalist-analyst/) -- Evaluates HAWKEYE dashboard usability and analyst workflow efficiency

## Related Capabilities

- [Real-Time Monitoring](/capabilities/real-time-monitoring/) -- Sub-100ms visitor analysis with live dashboard updates via PubSub
- [Intelligence Synthesis](/capabilities/intelligence-synthesis/) -- Multi-source threat intelligence fusion from AbuseIPDB, GreyNoise, and Shodan
- [Telemetry Integration](/capabilities/telemetry-integration/) -- Visitor processing metrics and bot detection accuracy monitoring
