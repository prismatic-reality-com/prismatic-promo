...
domain = "geopolitical"
level = "L3"
description = "Specialized intelligence agent for geopolitical risk assessment, international relations analysis, sanctions monitoring, and political stability evaluation"
category = "agent"
status = "Active"
agent_count = 1
academic_tier = "comprehensive"
glossary_terms = ["aiad", "no-mercy", "no-doubts", "otp", "telemetry", "osint", "nabla-infinity", "trinity-gate", "entity-resolution", "confidence-scoring"]
...
keywords = ["geopolitical-risk-analyst", "Specialized", "agents", "agent", "Prismatic Platform", "Geopolitical Risk", "Analyst", "Political", "Sanctions"]
tags = ["agents", "agent", "geopolitical-risk-analyst", "prismatic"]
see_also = ["commands", "apps", "glossary", "capabilities"]
image = "/images/sections/agents.png"
image_alt = "geopolitical-risk-analyst - Prismatic Platform"
+++
...
Sanctions regime monitoring tracks the evolving landscape of international sanctions imposed by the EU, United States, United Nations, and other sanctioning authorities. The agent monitors new designations, delistings, licensing exceptions, enforcement actions, and implementation guidance. For a platform operating within the Czech and EU regulatory environment, sanctions compliance has direct operational significance.

Regulatory landscape analysis monitors changes in regulatory environments across jurisdictions relevant to the platform's operations. New regulations, enforcement priorities, and regulatory cooperation agreements all affect the operational context for intelligence and financial investigations.

## Risk Assessment Methodology

The Geopolitical Risk Analyst produces structured risk assessments using a methodology that combines quantitative indicators with qualitative analytical judgment.
...
| Risk Dimension | Key Indicators | Collection Sources |
|---------------|----------------|-------------------|
| Political stability | Governance indices, election monitoring, protest tracking | OSINT feeds, government publications, media analysis |
| Interstate relations | Diplomatic communications, military positioning, trade flows | Official statements, think tank analysis, satellite imagery analysis |
| Sanctions | Designation lists, enforcement actions, guidance documents | Regulatory publications, legal databases, compliance advisories |
| Regulatory environment | Legislative tracking, enforcement trends, cooperation agreements | Official gazettes, regulatory websites, industry publications |
...
Quantitative indicator tracking monitors economic, social, and governance indicators that serve as leading or concurrent indicators of political risk changes. GDP growth, inflation, unemployment, trade balances, and institutional quality metrics all contribute to the quantitative picture.

## Entity-Level Geopolitical Context

The Geopolitical Risk Analyst enriches entity-level investigations with geopolitical context. When the platform's intelligence agents investigate a specific entity, the geopolitical analyst provides contextual information about the political, regulatory, and security environment in which that entity operates.

Jurisdictional risk assessment evaluates the risk characteristics of jurisdictions associated with an investigated entity -- incorporation jurisdictions, operational locations, banking jurisdictions, and counterparty locations. Entities with significant exposure to high-risk jurisdictions receive elevated geopolitical risk scores.

Sanctions exposure assessment evaluates whether an entity's operations, relationships, or jurisdictional exposure create sanctions compliance risks. This assessment considers not just direct sanctions designations but also sectoral sanctions, geographic sanctions programs, and sanctions evasion typologies.

Political exposure assessment evaluates connections between investigated entities and politically exposed persons (PEPs), government contracts, state-owned enterprises, and political party relationships. Political exposure creates both corruption risk and regulatory compliance requirements.
