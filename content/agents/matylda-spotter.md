...
The matylda-spotter agent operates as an L3 [Strategic Command](@/glossary/strategic-command.md) authority within the Prismatic Platform's tactical-specialist domain, serving as the forward observation and intelligence spotting specialist for the platform's tactical operations. Named after the Czech military tradition of precision observation, this agent provides the critical reconnaissance and target intelligence that enables precision engagement by tactical agents like the [marksman-jtac](@/agents/marksman-jtac.md). Where the JTAC coordinates the strike, the matylda-spotter identifies what needs to be struck.

Built on the [AIAD](@/glossary/aiad.md) standard and governed by the [NO MERCY, NO DOUBTS](@/glossary/no-mercy.md) doctrine, the matylda-spotter applies five core [Lean4](@/glossary/lean4.md) theorems that guarantee safe observation operations: observation completeness (no relevant target is missed within the defined observation scope), false-positive bounds (spurious targets do not exceed defined thresholds), temporal accuracy (observed conditions reflect current reality within defined staleness bounds), priority consistency (target priority rankings satisfy transitivity and completeness), and observation safety (observation operations do not alter the observed state).
...
|-------------------|-------------|-----------|
| [marksman-jtac](@/agents/marksman-jtac.md) | Provides target intelligence for engagement planning | Outbound |
| [code-quality-commander](@/agents/code-quality-commander.md) | Code quality observation data | Inbound |
| [performance-profiling-agent](@/agents/performance-profiling-agent.md) | Performance observation data | Inbound |
| [Prismatic Agents](@/glossary/prismatic-agents.md) | Runtime execution and lifecycle management | Infrastructure |
| Prismatic Telemetry | Observation [metrics](@/glossary/metrics.md) and SITREP publishing | Outbound |
| [SEADF](@/glossary/seadf.md) | Observation feeds into self-healing triggers | Outbound |
...
- [marksman-jtac](@/agents/marksman-jtac.md) -- Primary consumer of target intelligence
- [code-quality-commander](@/agents/code-quality-commander.md) -- Code quality domain data
- [Lean4](@/glossary/lean4.md) -- Formal verification for observation safety
- [AIAD Standard](@/glossary/aiad.md) -- Agent specification framework
- [NO MERCY, NO DOUBTS Doctrine](@/glossary/no-mercy.md) -- Observation rigor doctrine
- [NABLA Infinity](@/glossary/nabla-infinity.md) -- Epistemic framework for observation integrity
- [SEADF](@/glossary/seadf.md) -- Self-healing integration
