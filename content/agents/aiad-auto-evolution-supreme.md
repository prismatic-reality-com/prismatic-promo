...
- **Cross-specification pattern propagation** using the [CASCADE](/glossary/cascade/) engine and [mycelial network](/glossary/mycelial-network/) to distribute beneficial specification patterns discovered in one domain across all applicable agent families
...
| **[SEADF](/glossary/seadf/) (7 subsystems)** | Bidirectional | Consumes Scanner quality metrics; feeds specification improvements to Knowledge Sync |
| **[Mycelial Network](/glossary/mycelial-network/)** | Propagation substrate | Distributes specification pattern improvements across agent families |
| **[CASCADE](/glossary/cascade/) Engine** | Pattern deployment | Applies structural specification fixes across the registry |
| **[ARCHER SUPREME](/agents/archer-supreme/) (L1)** | Peer coordination | Defers during crisis interventions; resumes evolution post-resolution |
| **[Quality DNA](/glossary/quality-dna/)** | Cross-session persistence | Stores specification fitness history and evolution state across Claude sessions |
...
- [AIAD Standard](/capabilities/aiad-standard/) -- Specification standard governed by this agent
- [SEADF](/glossary/seadf/) -- Self-Evolving Autonomous Development Framework providing quality metrics
- [Trinity Gate](/glossary/trinity-gate/) -- Multi-layer validation system for specification changes
- [NABLA Infinity](/glossary/nabla-infinity/) -- Epistemic framework governing evolution operations
...
- [Applications](/apps/) -- 90+ umbrella applications with agent specifications
