+++
title = "risk-intelligence-commander"
weight = 356
[extra]
domain = "risk"
level = "L3"
...
keywords = ["risk-intelligence-commander", "Specialized", "agents", "agent", "Prismatic Platform", "Strategic Command", "OSINT", "NABLA Infinity"]
tags = ["agents", "agent", "risk-intelligence-commander", "prismatic"]
see_also = ["commands", "apps", "glossary", "capabilities"]
image = "/images/sections/agents.png"
image_alt = "risk-intelligence-commander - Prismatic Platform"
+++
...
**L3** - Strategic Command - Multi-domain coordination with authority to set risk context parameters that influence how downstream risk assessment agents weight individual risk factors.

## Command Interface

| Command | Description | Authority |
|---------|-------------|-----------|
| `/risk-intel briefing` | Generate strategic risk intelligence briefing for current environment | L3+ |
| `/risk-intel monitor` | Configure monitoring for specific geopolitical or economic risk indicators | L3+ |
| `/risk-intel trends` | Display emerging risk trend analysis with directional indicators | L3+ |
