...
- **Cross-team communication** -- Publishes structured findings to [Purple Team](@/teams/purple.md) for Red-Blue synthesis and to [Blue Team](@/teams/blue.md) for defensive posture adjustment
...
- **[Autonomous operation](@/capabilities/autonomous-self-healing.md)** with self-directed adversarial campaign cycles tuned to current defensive posture
- **[Telemetry integration](@/capabilities/telemetry-integration.md)** for attack execution monitoring and finding quality tracking
...
The **execution phase** deploys specialized agents -- [red-epistemic-attacker](@/agents/red-epistemic-attacker.md), [red-drift-inducer](@/agents/red-drift-inducer.md), and [red-scenario-generator](@/agents/red-scenario-generator.md) -- to carry out planned attacks within sandboxed environments. Each execution produces detailed logs of attack actions, observed system responses, and outcome measurements.
...
**L2** - Tactical Operations - Domain-specific [tactical execution](@/glossary/tactical-execution.md) with authority to orchestrate all Red Team operations, coordinate subordinate attack agents, and publish adversarial findings to cross-team synthesis channels.
...
| Agent | Relationship |
|-------|-------------|
| [red-epistemic-attacker](@/agents/red-epistemic-attacker.md) | Executes truth distortion and source poisoning attack scenarios |
| [red-drift-inducer](@/agents/red-drift-inducer.md) | Executes slow drift induction campaigns under strategic direction |
| [red-scenario-generator](@/agents/red-scenario-generator.md) | Generates multi-technique adversarial scenarios from the taxonomy |
| [purple-coordinator](@/agents/purple-coordinator.md) | Receives Red Team findings for Red-Blue synthesis and closure analysis |
| [blue-commander](@/agents/blue-commander.md) | Red Team findings inform defensive posture adjustments |
...
Red Team operations comply with the [NO MERCY](@/glossary/no-mercy.md) doctrine: adversarial testing is thorough, comprehensive, and uncompromising in its pursuit of defensive weaknesses. The [NO DOUBTS](@/glossary/no-doubts.md) principle ensures that all findings are evidence-based and reproducible. The [Trinity Gate](@/glossary/trinity-gate.md) validates Red Team findings before they enter the platform's defensive improvement pipeline, ensuring that remediation efforts address genuine vulnerabilities rather than testing artifacts.
