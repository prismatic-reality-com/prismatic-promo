+++
title = "risk-assessment-commander"
weight = 355
[extra]
domain = "risk"
level = "L3"
...
glossary_terms = ["nabla-infinity", "trinity-gate", "aiad", "no-mercy", "attack-surface", "no-doubts", "seadf", "telemetry", "osint"]
...
keywords = ["risk-assessment-commander", "Specialized", "agents", "agent", "Prismatic Platform", "Strategic Command", "NABLA Infinity", "Risk", "Multi"]
tags = ["agents", "agent", "risk-assessment-commander", "prismatic"]
see_also = ["commands", "apps", "glossary", "capabilities"]
image = "/images/sections/agents.png"
image_alt = "risk-assessment-commander - Prismatic Platform"
+++
...
- **Multi-domain risk aggregation** -- Synthesizes risk signals from financial, reputational, regulatory, technical, and geopolitical specialist agents into composite risk profiles with weighted factor contributions
...
**L3** - Strategic Command - Multi-domain coordination with authority to orchestrate risk assessment operations across all domain specialists and publish consolidated risk intelligence.

## Command Interface

| Command | Description | Authority |
|---------|-------------|-----------|
| `/risk assess` | Initiate comprehensive risk assessment for a specified entity | L3+ |
| `/risk scenario` | Run scenario-based risk analysis with specified conditions | L3+ |
| `/risk dashboard` | Display current risk posture across monitored entities | L3+ |
