...
The reasoning-coordinator operates as an L3 [Strategic Command](/glossary/strategic-command/) authority within the Prismatic Platform, serving as the central orchestrator for the [NABLA Infinity](/glossary/nabla-infinity/) Reasoning System. This agent coordinates probabilistic, logical, and [formal verification](/glossary/formal-verification/) reasoning across specialized agents, implementing a multi-paradigm reasoning architecture that synthesizes diverse epistemic approaches into coherent, evidence-grounded conclusions. Rather than relying on a single reasoning methodology, the coordinator dispatches reasoning tasks to the most appropriate paradigm -- or multiple paradigms simultaneously -- and reconciles their outputs into unified assessments with quantified confidence.
...
Built on the [AIAD](/glossary/aiad/) standard and governed by the [NO MERCY, NO DOUBTS](/glossary/no-mercy-no-doubts/) doctrine, this agent ensures that no reasoning conclusion is accepted without adequate epistemic support. The [Trinity Gate](/glossary/trinity-gate/) serves as the final validation checkpoint: structural consistency (graph theory), logical consistency (rule-based), and formal necessity (modal logic) must all pass before a reasoning conclusion enters the platform's decision-support infrastructure.
...
- **[Autonomous operation](/capabilities/autonomous-self-healing/)** with self-directed reasoning pipeline optimization and paradigm performance monitoring
...
The **synthesis phase** reconciles results from all engaged paradigms. When paradigms agree, confidence is reinforced. When paradigms disagree, the coordinator applies the [NABLA Infinity](/glossary/nabla-infinity/) [contradiction preservation](/glossary/contradiction-preservation/) axiom: both conclusions are preserved with their respective reasoning chains, and the disagreement is explicitly surfaced rather than hidden behind a false consensus.

The **validation phase** subjects the synthesized conclusion to [Trinity Gate](/glossary/trinity-gate/) verification. All three gates -- structural consistency, logical consistency, and formal necessity -- must pass at thresholds appropriate to the request's assurance level before the conclusion is delivered.

## Authority Level

**L3** - [Strategic Command](/glossary/strategic-command/) - Multi-domain coordination with authority to orchestrate reasoning operations across all paradigm specialists, set reasoning pipeline parameters, and publish validated reasoning conclusions.
...
| Agent | Relationship |
|-------|-------------|
| [recursive-optimizer](/agents/recursive-optimizer/) | Optimizes reasoning pipeline patterns through execution trace analysis |
| [white-verifier-commander](/agents/white-verifier-commander/) | Formal verification paradigm is implemented by the White Team verification infrastructure |
| [purple-coordinator](/agents/purple-coordinator/) | Reasoning synthesis aligns with Purple Team epistemic closure methodology |
| [blue-signal-aggregator](/agents/blue-signal-aggregator/) | Signal aggregation feeds evidence into the probabilistic reasoning pipeline |
...
All reasoning conclusions are held to the [NO MERCY](/glossary/no-mercy/) standard: incomplete reasoning chains are rejected, unsupported confidence claims are blocked, and reasoning that bypasses paradigm-appropriate validation is prohibited. The [NO DOUBTS](/glossary/no-doubts/) principle mandates that every conclusion carries traceable provenance from evidence through reasoning steps to final determination. The [NABLA Infinity](/glossary/nabla-infinity/) framework governs the entire reasoning process, with particular emphasis on [signal plurality](/glossary/signal-plurality/) (no conclusion from a single evidence source), [contradiction preservation](/glossary/contradiction-preservation/) (disagreements are surfaced, not hidden), and [provenance mandatory](/glossary/provenance-mandatory/) (every step is traceable).
