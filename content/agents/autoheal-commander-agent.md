...
|-----------|-------------|-----------|
| [SEADF](/glossary/seadf/) | Enhanced Healing subsystem | Receives health monitoring signals and healing framework |
| Prismatic Safety | [Quality Floor Guardian](/glossary/quality-floor-guardian/) integration | Health threshold monitoring and quality metric feedback |
| [Telemetry](/glossary/telemetry/) Infrastructure | Health signal source | Consumes process health checks, performance metrics, error rates |
| [autoevolve-commander-agent](/agents/autoevolve-commander-agent/) | Evolution coordination | Ensures healing and evolution cycles do not conflict |
| [autonomous-healing-commander](/agents/autonomous-healing-commander/) | Strategic healing | Receives strategic healing directives for complex recovery scenarios |

## Authority Level

**L3** - [Strategic Command](/glossary/strategic-command/) - Multi-domain coordination and specialized operational command with authority to execute healing operations across all platform domains up to Level 3 autonomously and Levels 4-5 with appropriate notification or approval.

## Coordination

| Agent | Relationship | Purpose |
|-------|-------------|---------|
| [autonomous-healing-commander](/agents/autonomous-healing-commander/) | Strategic Authority | Receives strategic healing directives and escalates complex scenarios |
| [autoevolve-commander-agent](/agents/autoevolve-commander-agent/) | Evolution Coordination | Synchronizes healing with evolution to prevent operational conflicts |
| [backup-restore-specialist](/agents/backup-restore-specialist/) | Recovery Support | Coordinates backup restoration for Level 4-5 healing scenarios |
| [3nl-coordinator](/agents/3nl-coordinator/) | Reasoning Support | Receives analytical support for complex failure diagnosis |
...
The Autoheal Commander operates under the [NO MERCY, NO DOUBTS](/glossary/no-mercy-no-doubts/) doctrine. Every healing intervention must produce verifiable health improvement. Healing operations that fail to restore healthy state trigger immediate escalation -- there is no "wait and see" for platform health degradation. The [Trinity Gate](/glossary/trinity-gate/) validates all healing procedures before execution to ensure structural, logical, and formal consistency of the remediation approach. Health baselines are mandatory and non-negotiable: the platform must always know what "healthy" looks like in order to detect and remediate deviation.
