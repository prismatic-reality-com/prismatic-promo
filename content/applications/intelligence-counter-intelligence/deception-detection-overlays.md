...
- [Insider threat detection](/applications/defense-security/insider-threat-detection/) — *Defense Security*
- [Coordinated inauthentic behavior detection](/applications/content-moderation-manipulation/coordinated-inauthentic-behavior-detection/) — *Content Moderation Manipulation*
- [Cross-lingual manipulation detection](/applications/content-moderation-manipulation/cross-lingual-manipulation-detection/) — *Content Moderation Manipulation*
- [Operational deception sandbox](/applications/defense-security/operational-deception-sandbox/) — *Defense Security*
