...
- [Multi-agent hedge fund](/applications/algorithmic-trading-finance/multi-agent-hedge-fund/) — *Algorithmic Trading Finance*
- [Multi-agent conservation societies](/applications/sustainability-ecology/multi-agent-conservation-societies/) — *Sustainability Ecology*
- [After-action review automation](/applications/defense-security/after-action-review-automation/) — *Defense Security*
- [Disaster resilience simulation](/applications/sustainability-ecology/disaster-resilience-simulation/) — *Sustainability Ecology*
