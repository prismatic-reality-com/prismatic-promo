...
8. **Reporting**: Output the health report in the requested format. Emit [telemetry](@/glossary/telemetry.md) events for health monitoring dashboards. Store health check results for trend analysis.

## Integration Points

| Component | Integration Type | Description |
|-----------|-----------------|-------------|
| [Prismatic Agents](@/glossary/prismatic-agents.md) | Agent Execution | Executed by `health-check-agent` at L2+ authority |
| [Quality Gates](@/glossary/quality-gates.md) | Pre-deployment Check | Health check is a mandatory gate before deployments |
| [Telemetry](@/glossary/telemetry.md) | Continuous Monitoring | Health metrics feed into platform telemetry dashboards |
| [Prismatic Web](@/apps/prismatic-web.md) | Dashboard Display | Health status displayed in LiveView operations dashboard |
| [/guardrails](@/commands/guardrails.md) | Deployment Safety | Health checks are a guardrail for deployment gates |
...
All health check operations enforce the **[NO MERCY, NO DOUBTS](@/glossary/no-mercy-no-doubts.md)** doctrine.
